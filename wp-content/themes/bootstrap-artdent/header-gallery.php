...
<div class="header-wrapper-gallery">
<div class="container-fluid custom-header-bar-gallery hidden-md-down">
...
<header class="intro-header" id="header">
    <div class="container-fluid section-name gallery">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <h1 class="section-name-h gallery-h">Galeria</h1>
            </div>
...
<!-- Wrapper -->
<div class="container-full-height-gallery">
