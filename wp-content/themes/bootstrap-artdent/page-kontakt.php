...
<div class="content-wrapper-r">
    ...
    <!--                    <h3>Gabinet Kraków</h3>-->
    <!--                    <ul class="list-contact pull-left">-->
    ...
    <!---->
    <!--                    </ul>-->
    <!--                    <ul class="list-contact pull-right">-->
